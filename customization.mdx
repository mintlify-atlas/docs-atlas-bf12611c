...
description: "Configure Tidgrid's SCSS variables to change class syntax, namespace prefix, breakpoints, gap sizes, row sizes, and layout spacing before compilation."
---
...
@use 'tidgrid/src/index' with (
  ...
  // Row column sizes (src/grid/row.scss)
  $row-sizes: (12,),
