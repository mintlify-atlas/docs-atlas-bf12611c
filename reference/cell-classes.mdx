---
title: "Cell Classes — Tidgrid Flexbox Cell Reference"
...
Fraction variants set a fixed `flex-basis` on an individual cell, overriding any width set by the parent row. Use these to mix column sizes inside a single row.
...
| `.tg-frac(2/3)` | `width: 66.667%; flex: none` |
